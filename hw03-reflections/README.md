...
!!!Решение включает три главных пакета:
ru.otus.d13.reflection.someclasses - тестируемые классы
ru.otus.d13.reflection.test - классы тестов
ru.otus.d13.reflection.testfw - классы framework

ru.otus.d13.reflection.TestFrameworkApplication - класс запуска, содержащий метод main()
