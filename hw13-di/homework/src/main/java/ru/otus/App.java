...
import ru.otus.config.v1.AppConfig;
import ru.otus.config.v2.AppConfig1;
import ru.otus.config.v2.AppConfig2;
...
//        AppComponentsContainer container = new AppComponentsContainerImpl("ru.otus.config.v2");
