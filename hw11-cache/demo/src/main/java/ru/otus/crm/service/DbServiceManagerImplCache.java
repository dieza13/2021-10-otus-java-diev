...
public class DbServiceManagerImplCache implements DBServiceManager {
    private static final Logger log = LoggerFactory.getLogger(DbServiceManagerImplCache.class);

    private final DataTemplate<Manager> managerDataTemplate;
    private final TransactionRunner transactionRunner;
    private final HwCache<Long, Manager> managerCache;

    public DbServiceManagerImplCache(TransactionRunner transactionRunner, DataTemplate<Manager> managerDataTemplate) {
